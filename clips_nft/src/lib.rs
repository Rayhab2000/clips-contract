...
impl ClipsNftContract {
    ...
    // -------------------------------------------------------------------------
    // Task 1: Safe math ΓÇö mint with overflow-safe royalty validation
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // Task 2: Admin-only config ΓÇö set_platform_fee, set_default_royalty
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // Task 3: get_user_tokens ΓÇö O(1) index-based pagination
    // -------------------------------------------------------------------------

    /// Return token IDs owned by `owner`. O(limit) ΓÇö reads from OwnerTokenIndex.
    ...
    /// Task 1: safe-math royalty calculation ΓÇö delegates to safe_math module
